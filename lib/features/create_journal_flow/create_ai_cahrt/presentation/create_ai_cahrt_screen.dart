...
class CreateAiCahrtScreen extends StatefulWidget {
  const CreateAiCahrtScreen({super.key});

  @override
  State<CreateAiCahrtScreen> createState() => _CreateAiCahrtScreenState();
}

class _CreateAiCahrtScreenState extends State<CreateAiCahrtScreen> {
