...
class InspriationScreen extends StatefulWidget {
  final int step;
  const InspriationScreen({super.key, this.step = 5});

  @override
  State<InspriationScreen> createState() => _InspriationScreenState();
}

class _InspriationScreenState extends State<InspriationScreen> {
...
///================================= button ==============================//
      ...
      bottomNavigationBar:   Padding(
        ...
        child: CustomElevatedButton(
          ...
          text: 'Next',
          onPressed: () {
            NavigationService.navigateTo(Routes.experienceScreen);
          },
        ),
      ),
    );
