...
class JourneySetupConfirmationScreen extends StatefulWidget {
  const JourneySetupConfirmationScreen({super.key});

  @override
  State<JourneySetupConfirmationScreen> createState() => _JourneySetupConfirmationScreenState();
}

class _JourneySetupConfirmationScreenState extends State<JourneySetupConfirmationScreen> {
  @override
            ...
            child: Column(
              children: [
                ...
                CustomElevatedButton(
                  ...
                  onPressed: () {
                    NavigationService.navigateTo(Routes.createAiCahrtScreen);
                  },
                ),
              ],
            ),
