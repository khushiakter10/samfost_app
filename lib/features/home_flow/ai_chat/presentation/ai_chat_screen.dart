...
class _AiChatScreenState extends State<AiChatScreen> {
  ...
  Widget _buildInputWidget() {
    return Container(
      height: 48.h,
      margin: EdgeInsets.only(bottom: 18.h, left: 12.w, right: 12.w),
      ...
      child: Row(
        children: [
          CustomImageView(imagePath: AppIcons.addImageBtnIcon),
          UIHelper.horizontalSpace(4.w),
          CustomImageView(imagePath: AppIcons.addRecordBtnIcon),
          ...
          Expanded(
            child: CustomTextfield(
              ...
              hintTextSyle: TextFontStyle.textStylePlusJakartaSans.copyWith(
                fontSize: 10.sp,
          ...
          CustomImageView(imagePath: AppIcons.sendMsgBtnIcon),
        ],
      ),
    );
  }
