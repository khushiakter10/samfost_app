...
class FirstMemorySavedScreen extends StatefulWidget {
  const FirstMemorySavedScreen({super.key});

  @override
  State<FirstMemorySavedScreen> createState() => _FirstMemorySavedScreenState();
}

class _FirstMemorySavedScreenState extends State<FirstMemorySavedScreen> {
  @override
...
///=============================== button ==================================//
                CustomElevatedButton(
                  ...
                  onPressed: () {
                    NavigationService.navigateTo(Routes.aiGeneratedJournalStoryScreen);
                  },
                ),
