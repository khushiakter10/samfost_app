...
class JornalAiChartScreen extends StatefulWidget {
  const JornalAiChartScreen({super.key,});

  @override
  State<JornalAiChartScreen> createState() =>
      _JornalAiChartScreenState();
}

class _JornalAiChartScreenState
    extends State<JornalAiChartScreen> {
  ///===================== dotted=========================//
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomArrowButton(
                  voidCallback: (){NavigationService.goBack;}
                ),
