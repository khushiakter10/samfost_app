...
class AiThreeMenuallyJournalStoryScreen extends StatefulWidget {
  const AiThreeMenuallyJournalStoryScreen({super.key,});

  @override
  State<AiThreeMenuallyJournalStoryScreen> createState() =>
      _AiThreeMenuallyJournalStoryScreenState();
}

class _AiThreeMenuallyJournalStoryScreenState
    extends State<AiThreeMenuallyJournalStoryScreen> {
  ///===================== dotted=========================//
