...
class ManualActivitesScreen extends StatefulWidget {
  final int step;
  const ManualActivitesScreen({super.key, this.step = 4});

  @override
  State<ManualActivitesScreen> createState() => _ManualActivitesScreenState();
}

class _ManualActivitesScreenState extends State<ManualActivitesScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:   Padding(
        ...
        child: CustomElevatedButton(
          ...
          text: 'Continue',
          onPressed: () {
            NavigationService.navigateTo(Routes.manualSetupConditionScreen);
          },
        ),
      ),
    );
