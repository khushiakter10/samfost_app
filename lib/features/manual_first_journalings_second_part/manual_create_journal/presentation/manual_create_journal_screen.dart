...
class ManualCreateJournalScreen extends StatelessWidget {
  const ManualCreateJournalScreen({super.key});
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child:  CustomElevatedButton(
          ...
          text: 'Next', onPressed: () {
          NavigationService.navigateTo(Routes.manualNameOfTripScreen);
        },),
      ),
    );
  }
