...
class ManualExperenceScreen extends StatefulWidget {
  final int step;
  const ManualExperenceScreen({super.key, this.step = 6});

  @override
  State<ManualExperenceScreen> createState() => _ManualExperenceScreenState();
}

class _ManualExperenceScreenState extends State<ManualExperenceScreen> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomElevatedButton(
                          ...
                          text: 'Next',
                          onPressed: () {
                            NavigationService.navigateTo(Routes.manualActivitesScreen);
                          },
                        ),
