...
class ManualJournalPartnerScreen extends StatefulWidget {
  final int step;
  const ManualJournalPartnerScreen({super.key, this.step = 4});

  @override
  State<ManualJournalPartnerScreen> createState() => _ManualJournalPartnerScreenState();
}

class _ManualJournalPartnerScreenState extends State<ManualJournalPartnerScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:   Padding(
        ...
        child: CustomElevatedButton(
          ...
          text: 'Next',
          onPressed: () {
            NavigationService.navigateTo(Routes.manualInspriationScreen);
          },
        ),
      ),
    );
