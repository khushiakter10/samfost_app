...
class ManualNameOfTripScreen extends StatefulWidget {
  final int step;
  const ManualNameOfTripScreen({super.key, this.step = 0});

  @override
  State<ManualNameOfTripScreen> createState() => _ManualNameOfTripScreenState();
}

class _ManualNameOfTripScreenState extends State<ManualNameOfTripScreen> {
  double get progress {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomElevatedButton(
          ...
          text: 'Next',
          onPressed: () {
            NavigationService.navigateTo(Routes.manualPlaceScreen);
          },
        ),
      ),
