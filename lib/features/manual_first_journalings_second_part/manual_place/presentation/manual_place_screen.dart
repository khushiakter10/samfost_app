...
class ManualPlaceScreen extends StatefulWidget {
  final int step;
  const ManualPlaceScreen({super.key, this.step = 1});

  @override
  State<ManualPlaceScreen> createState() => _ManualPlaceScreenState();
}

class _ManualPlaceScreenState extends State<ManualPlaceScreen> {
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomElevatedButton(
          ...
          onPressed: () {
            ...
            NavigationService.navigateTo(Routes.manualPlaceOptionScreen);
          },
        ),
      ),
    );
