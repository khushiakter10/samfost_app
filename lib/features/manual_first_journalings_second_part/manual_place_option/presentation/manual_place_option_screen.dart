...
class ManualPlaceOptionScreen extends StatefulWidget {
  final int step;
  const ManualPlaceOptionScreen({super.key, this.step = 3});

  @override
  State<ManualPlaceOptionScreen> createState() => _ManualPlaceOptionScreenState();
}

class _ManualPlaceOptionScreenState extends State<ManualPlaceOptionScreen> {
        ...
        child: CustomElevatedButton(
          ...
          onPressed: () {
            if (_formKey.currentState!.validate()) {
              ...
              NavigationService.navigateTo(Routes.manualJournalPartnerScreen);
            }
          },
        ),
      ),
