...
class SubcriptionAfterFreeScreen extends StatefulWidget {
  const SubcriptionAfterFreeScreen({super.key});

  @override
  State<SubcriptionAfterFreeScreen> createState() => _SubcriptionAfterFreeScreenState();
}

class _SubcriptionAfterFreeScreenState extends State<SubcriptionAfterFreeScreen> {
