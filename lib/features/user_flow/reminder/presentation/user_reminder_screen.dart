...
class UserReminderScreen extends StatefulWidget {
  const UserReminderScreen({super.key});

  @override
  State<UserReminderScreen> createState() => _UserReminderScreenState();
}

class _UserReminderScreenState extends State<UserReminderScreen> {
  bool isOf = false;
  bool isOn = false;
