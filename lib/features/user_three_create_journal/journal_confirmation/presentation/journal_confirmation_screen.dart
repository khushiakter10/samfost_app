...
class JournalConfirmationScreen extends StatefulWidget {
  const JournalConfirmationScreen({super.key});

  @override
  State<JournalConfirmationScreen> createState() => _JournalConfirmationScreenState();
}

class _JournalConfirmationScreenState extends State<JournalConfirmationScreen> {
  @override
            ...
            child: Column(
              children: [
                ...
                CustomElevatedButton(
                  ...
                  onPressed: () {
                    NavigationService.navigateTo(Routes.journalSubcriptionPopUpScreen);
