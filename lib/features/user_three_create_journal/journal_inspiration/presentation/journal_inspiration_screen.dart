...
class JournalInspirationScreen extends StatefulWidget {
  final int step;
  const JournalInspirationScreen({super.key, this.step = 5});

  @override
  State<JournalInspirationScreen> createState() => _JournalInspirationScreenState();
}

class _JournalInspirationScreenState extends State<JournalInspirationScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:   Padding(
        ...
        child: CustomElevatedButton(
          ...
          text: 'Next',
          onPressed: () {
            NavigationService.navigateTo(Routes.journalExperienceScreen);
          },
        ),
      ),
    );
