...
import 'package:samfost_app/common_widgets/custom_tag_input.dart';
...
class JournalPlaceScreen extends StatefulWidget {
  final int step;
  const JournalPlaceScreen({super.key, this.step = 1});

  @override
  State<JournalPlaceScreen> createState() => _JournalPlaceScreenState();
}

class _JournalPlaceScreenState extends State<JournalPlaceScreen> {
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomElevatedButton(
          ...
          onPressed: () {
            ...
            NavigationService.navigateTo(Routes.tripStartPlaceScreen);
          },
        ),
      ),
    );
