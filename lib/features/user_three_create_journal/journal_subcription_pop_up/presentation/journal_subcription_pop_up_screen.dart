...
import 'package:samfost_app/features/user_flow/subscription_pop_up/widget/custom_weekly.dart';
import 'package:samfost_app/features/user_three_create_journal/journal_subcription_pop_up/widget/journal_prompts.dart';
import 'package:samfost_app/helpers/all_routes.dart';
import 'package:samfost_app/helpers/navigation_service.dart';
import 'package:samfost_app/helpers/ui_helpers.dart';

class JournalSubcriptionPopUpScreen extends StatefulWidget {
  const JournalSubcriptionPopUpScreen({super.key});

  @override
  State<JournalSubcriptionPopUpScreen> createState() =>
      _JournalSubcriptionPopUpScreenState();
}

class _JournalSubcriptionPopUpScreenState extends State<JournalSubcriptionPopUpScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: CustomWeekly(isSelected: selectedIndex == 0, title: 'Weekly', subtitle: '£4.49/week',),
              ),
              ...
              GestureDetector(
                ...
                child: CustomWeekly(isSelected: selectedIndex == 1, title: 'Monthly', subtitle: '£9.99/month',),
              ),
              ...
              CustomElevatedButton(
                ...
                NavigationService.navigateTo(Routes.journalThreeAiChartScreen);
              }),
              UIHelper.verticalSpace(16.h),

              GestureDetector(
                onTap: (){NavigationService.navigateTo(Routes.manualJournalScreen);},
                child: Center(
                  child: Text(
