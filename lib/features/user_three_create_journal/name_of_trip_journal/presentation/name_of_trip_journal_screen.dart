...
class NameOfTripJournalScreen extends StatefulWidget {
  final int step;
  const NameOfTripJournalScreen({super.key, this.step = 0});

  @override
  State<NameOfTripJournalScreen> createState() => _NameOfTripJournalScreenState();
}

class _NameOfTripJournalScreenState extends State<NameOfTripJournalScreen> {
  double get progress {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomElevatedButton(
          ...
          text: 'Next',
          onPressed: () {
            NavigationService.navigateTo(Routes.journalPlaceScreen);
          },
        ),
      ),
