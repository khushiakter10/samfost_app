...
class TripStartPlaceScreen extends StatefulWidget {
  final int step;
  const TripStartPlaceScreen({super.key, this.step = 3});

  @override
  State<TripStartPlaceScreen> createState() => _TripStartPlaceScreenState();
}

class _TripStartPlaceScreenState extends State<TripStartPlaceScreen> {
        ...
        child: CustomElevatedButton(
          ...
          onPressed: () {
            if (_formKey.currentState!.validate()) {
              ...
              NavigationService.navigateTo(Routes.partnerJourneyScreen);
            }
          },
        ),
      ),
